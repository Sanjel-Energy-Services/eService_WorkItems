...
graph TB
    ...
    subgraph "微服务层 Microservices"
        D[用户认证服务<br/>Authentication Service]
        E[程序请求服务<br/>Program Request Service]
        F[审批工作流服务<br/>Approval Workflow Service]
        G[通知服务<br/>Notification Service]
        H[文档管理服务<br/>Document Service]
        I[报表服务<br/>Reporting Service]
    end
