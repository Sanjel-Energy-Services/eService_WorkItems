...
-- Step 1: Insert Master Data to SanjelData database		   
		   
/*
-- Run on Production on Sep 28, 2023
Use [##SanjelData##]
GO
DROP Table [RemedialObjective];
GO
...
DROP Table [##SanjelData##].[dbo].[WellObjective];
GO
CREATE TABLE [##SanjelData##].[dbo].[WellObjective]([id] [int] IDENTITY(1,1) NOT NULL,	[entity_status] [int] NULL,	[owner_id] [int] NULL,	[name] [nvarchar](100) NULL,	[description] [nvarchar](500) NULL);
GO
...
Drop table [##SanjelData##].[dbo].[WellType]
GO
CREATE TABLE [##SanjelData##].[dbo].[WellType]([id] [int] IDENTITY(1,1) NOT NULL,	[entity_status] [int] NULL,	[owner_id] [int] NULL,	[name] [nvarchar](100) NULL,	[description] [nvarchar](500) NULL);
GO
...
ALTER TABLE [##SanjelData##].[dbo].[RigJob] ADD [WellLocationType] [int] NULL;
GO
*/

Update [##SanjelData##].[dbo].RigJob Set WellLocationType = WellLocationTypeid;
Go
...
Go
CREATE TABLE [hse_PrimaryIncidentPerformanceMetric] ([id] [int] IDENTITY(1,1) NOT NULL,[entity_status] [int] NULL,owner_id int NULL,name [nvarchar](100) NULL,description [nvarchar](500) NULL,[PerformanceMetricid] int,[PerformanceMetricName] [nvarchar](100) NULL,[PerformanceMetricDescription] [nvarchar](500) NULL,[PerformanceMetricSystemId] [int] Not NULL,[PrimaryIncidentid] int,[PrimaryIncidentName] [nvarchar](100) NULL,[PrimaryIncidentDescription] [nvarchar](500) NULL,[PrimaryIncidentSystemId] [int] Not NULL);
GO
CREATE TABLE [ChangeRequest] ([id] [int] NOT NULL,[entity_status] [int] NULL,owner_id int NULL,name [nvarchar](100) NULL,description [nvarchar](500) NULL,system_id [int] IDENTITY(1,1) Not NULL,version [int] NULL,modified_user_id [int] NULL,modified_user_name nvarchar(255),modified_datetime datetime2,operation_type  [int] NULL,effective_start_datetime datetime2,effective_end_datetime datetime2,[JobUniqueId] nvarchar(255),[JobNumber] nvarchar(255),[JobType] nvarchar(255),[RigName] nvarchar(255),[ServicePoint] nvarchar(255),[Supervisor] nvarchar(255),[JobDateTime] datetime,[ClientCompany] nvarchar(255),[ClientRep] nvarchar(255),[WellName] nvarchar(255),[DownHoleLocation] nvarchar(255),[SurfaceLocation] nvarchar(255),[Status] int,[ChangeRequestType] int,[Reason] int,[RiskPreMOC] int,[RiskPostMOC] int,[IsApprovalRequired] bit,[IsOSRSignatureRequired] bit,[OSRSignedBy] nvarchar(255),[ApprovedBy] nvarchar(255),[DescriptionOfChange] [nvarchar](500),[DescriptionOfControl] [nvarchar](500));
GO
*/
USE [##SanjelData##]
GO
...
-- Step 2: Update eService6 database
...
/*
-- Run on Production on Sep 28, 2023
ALTER TABLE [##eService6##].[dbo].[CALLSHEET_HEADERS]
ADD [WLI_WELL_TYPE_ID] [int] NULL,
    [WLI_WELL_TYPE_NAME] [nvarchar](255) NULL,
    [WLI_WELL_OBJECTIVE_ID] [int] NULL,
    [WLI_WELL_OBJECTIVE_NAME] [nvarchar](255) NULL,
    [WLI_REMEDIAL_OBJECTIVE_ID] [int] NULL,
    [WLI_REMEDIAL_OBJECTIVE_NAME] [nvarchar](255) NULL,
	[BHC_WELL_OBJECTIVE_ID] [int] NULL,
    [BHC_WELL_OBJECTIVE_NAME] [nvarchar](255) NULL;
GO

ALTER TABLE [##eService6##].[dbo].[JOBS]
ADD [WLI_WELL_TYPE_ID] [int] NULL,
    [WLI_WELL_TYPE_NAME] [nvarchar](255) NULL,
    [WLI_WELL_OBJECTIVE_ID] [int] NULL,
    [WLI_WELL_OBJECTIVE_NAME] [nvarchar](255) NULL,
...
ALTER TABLE [##eService6##].[dbo].[PUMPING_SERVICE_REPORTS]
ADD [BHC_WELL_OBJECTIVE_ID] [int] NULL,
    [BHC_WELL_OBJECTIVE_NAME] [nvarchar](255) NULL;
GO
*/

UPDATE [##eService6##].[dbo].[CALLSHEET_HEADERS] SET
[BHC_WELL_OBJECTIVE_ID] =2,
[BHC_WELL_OBJECTIVE_NAME]='Oil'
where
bhc_well_type_id = 2;
GO

UPDATE [##eService6##].[dbo].[CALLSHEET_HEADERS] SET
[BHC_WELL_OBJECTIVE_ID] =7,
[BHC_WELL_OBJECTIVE_NAME]='Gas'
where
bhc_well_type_id = 7;
GO
...
UPDATE [##eService6##].[dbo].[CALLSHEET_HEADERS] SET
[BHC_WELL_OBJECTIVE_ID] =8,
[BHC_WELL_OBJECTIVE_NAME]='Other'
where
bhc_well_type_id = 8;
GO

UPDATE [##eService6##].[dbo].[PUMPING_SERVICE_REPORTS] SET
[BHC_WELL_OBJECTIVE_ID] =2,
[BHC_WELL_OBJECTIVE_NAME]='Oil'
where
bhc_well_type_id = 2;
...
bhc_well_type_id = 8;
GO
/*Have run in production already
...
/*
-- Run on Production on Sep 28, 2023
ALTER TABLE [##eService6##].[dbo].[RPT_HSE_INCIDENT_DTL_SCTNS] ADD [HSE_PRIMARYINCIDENT_TYPE_ID] [int] NULL;
GO
ALTER TABLE [##eService6##].[dbo].[RPT_HSE_INCIDENT_DTL_SCTNS] ADD [HSE_PRIMARYINCIDENT_TYPE_NAME] nvarchar(100) NULL;
GO
*/
...
CREATE SYNONYM [dbo].[SYN_SD_hse_IncidentTypePerformanceMetric] FOR [##SanjelData##].[dbo].[hse_IncidentTypePerformanceMetric]
GO
CREATE SYNONYM [dbo].[SYN_SD_hse_PrimaryIncident] FOR [##SanjelData##].[dbo].[hse_PrimaryIncident]
GO
CREATE SYNONYM [dbo].[SYN_SD_hse_PrimaryIncidentActualSeverity] FOR [##SanjelData##].[dbo].[hse_PrimaryIncidentActualSeverity]
GO
CREATE SYNONYM [dbo].[SYN_SD_hse_PrimaryIncidentIncidentType] FOR [##SanjelData##].[dbo].[hse_PrimaryIncidentIncidentType]
GO
CREATE SYNONYM [dbo].[SYN_SD_hse_PrimaryIncidentPerformanceMetric] FOR [##SanjelData##].[dbo].[hse_PrimaryIncidentPerformanceMetric]
GO
...
/****** Object:  Synonym [dbo].[SYN_SD_IncidentType]    Script Date: 2023/9/14 13:57:29 ******/
CREATE SYNONYM [dbo].[SYN_SD_hse_IncidentType] FOR [##SanjelData##].[dbo].[hse_IncidentType]
GO
...
/****** Object:  Synonym [dbo].[SYN_SD_PerformanceMetric]    Script Date: 2023/9/14 13:57:29 ******/
CREATE SYNONYM [dbo].[SYN_SD_hse_PerformanceMetric] FOR [##SanjelData##].[dbo].[hse_PerformanceMetric]
GO
...
/****** Object:  Synonym [dbo].[SYN_SD_PotentialSeverity]    Script Date: 2023/9/14 14:03:55 ******/
CREATE SYNONYM [dbo].[SYN_SD_hse_PotentialSeverity] FOR [##SanjelData##].[dbo].[hse_PotentialSeverity]
GO
...
/****** Object:  Synonym [dbo].[SYN_SD_QualityObservationType]    Script Date: 2023/9/14 14:05:07 ******/
CREATE SYNONYM [dbo].[SYN_SD_hse_QualityObservationType] FOR [##SanjelData##].[dbo].[hse_QualityObservationType]
GO
...
/****** Object:  Synonym [dbo].[SYN_SD_SeverityMatrixtype]    Script Date: 2023/9/14 14:05:54 ******/
CREATE SYNONYM [dbo].[SYN_SD_hse_SeverityMatrixtype] FOR [##SanjelData##].[dbo].[hse_SeverityMatrixtype]
GO
...
CREATE VIEW [dbo].[PrimaryIncident_ActualSeverity] AS 
	...
	with orderedRecords as (
		...
		from dbo.SYN_SD_hse_PrimaryIncidentActualSeverity
	)
	select 	
	   [id]
      ,[entity_status]
...
CREATE VIEW [dbo].[PrimaryIncident_IncidentType] AS 
	...
	with orderedRecords as (
		select ROW_NUMBER() OVER (Partition By Id ORDER BY id desc) as rowNum, *
		from dbo.SYN_SD_hse_PrimaryIncidentIncidentType
	)
	select 	
	  [id]
      ,[entity_status]
...
CREATE VIEW [dbo].[IncidentType_PerformanceMetric] AS 
	...
	with orderedRecords as (
		select ROW_NUMBER() OVER (Partition By Id ORDER BY id desc) as rowNum, *
		from dbo.SYN_SD_hse_IncidentTypePerformanceMetric
	)
	select 	
		[id]
      ,[entity_status]
...
CREATE VIEW [dbo].[PrimaryIncident_PerformanceMetric] AS 

	with orderedRecords as (
		select ROW_NUMBER() OVER (Partition By Id ORDER BY id desc) as rowNum, *
		from dbo.SYN_SD_hse_PrimaryIncidentPerformanceMetric
	)
	select 	
		[id]
      ,[entity_status]
...
(
    select
        ...
        ,GETDATE()   EFFECTIVE_START_DATE_TIME
        ,'9999-12-31 23:59:59.0000000'    EFFECTIVE_END_DATE_TIME
        --, entity_status
        --, owner_id
    from dbo.SYN_SD_hse_PrimaryIncident
),mdm_m as 
(
    select
        6127000 + id        ID
...
(
    select
        ...
        --, owner_id
    from 
        (select ROW_NUMBER() OVER (Partition By Id ORDER BY Version desc) as rowNum, * from dbo.SYN_SD_hse_QualityObservationType) a
    where 
        rowNum = 1
)
,mdm_f as 
(
    select
        ...
        --, owner_id
    from 
        (select ROW_NUMBER() OVER (Partition By Id ORDER BY Version desc) as rowNum, * from dbo.SYN_SD_hse_PotentialSeverity) a
    where 
        rowNum = 1
)
,mdm_117 as 
(
    select
        ...
        --, owner_id
    from 
        (select ROW_NUMBER() OVER (Partition By Id ORDER BY Version desc) as rowNum, * from dbo.SYN_SD_hse_PerformanceMetric) a
    where 
        rowNum = 1
)
,es_117_extra as 
...
(
    select
        ...
        --, owner_id
    from 
        (select ROW_NUMBER() OVER (Partition By Id ORDER BY Version desc) as rowNum, * from dbo.SYN_SD_hse_IncidentType) a
    where 
        rowNum = 1
)
,es_116_extra as 
...
(
    select
        ...
        --, owner_id
    from 
        (select ROW_NUMBER() OVER (Partition By Id ORDER BY Version desc) as rowNum, * from dbo.SYN_SD_hse_SeverityMatrixtype) a
    where 
        rowNum = 1
)
,es_115_extra as 
...
-- Step 3: Update SanjelData views to eService 6
