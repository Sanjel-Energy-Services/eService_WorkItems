...
update ProductHaulLoad set BulkPlantid = ????, BulkPlantName = 'GP Bulk Plant' where ServicePointid = 71;
update ProductHaulLoad set BulkPlantid = 2342, BulkPlantName = 'SC Bulk Plant' where ServicePointid = 70;
update ProductHaulLoad set BulkPlantid = 2343, BulkPlantName = 'LLD Bulk Plant' where ServicePointid = 61;
update ProductHaulLoad set BulkPlantid = 2344, BulkPlantName = 'LLB Bulk Plant' where ServicePointid = 65;
update ProductHaulLoad set BulkPlantid = 2345, BulkPlantName = 'EDM Bulk Plant' where ServicePointid = 67;
update ProductHaulLoad set BulkPlantid = 2346, BulkPlantName = 'EST Bulk Plant' where ServicePointid = 72;
update ProductHaulLoad set BulkPlantid = 2347, BulkPlantName = 'RD Bulk Plant' where ServicePointid = 85;
update ProductHaulLoad set BulkPlantid = 2348, BulkPlantName = 'FSJ Bulk Plant' where ServicePointid = 66;	
