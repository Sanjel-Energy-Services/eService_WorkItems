...
--upgrade Well Library
--GitHub Project:https://github.com/orgs/Sanjel-Energy-Services/projects/20?pane=issue&itemId=36101291
USE [SanjelData]
GO
...
ALTER TABLE BlendSample ADD ProductHaulLoadid int;
ALTER TABLE BlendSample ADD ProductHaulLoadName nvarchar(100) NULL;
ALTER TABLE BlendSample ADD ProductHaulLoadDescription nvarchar(500) NULL;
ALTER TABLE BlendSample ADD ProductHaulLoadSystemId int NOT NULL;
ALTER TABLE BlendSample ADD DateCollected datetime;
ALTER TABLE BlendSample ADD SampleBarCode nvarchar(255);
ALTER TABLE BlendSample ADD Amount float;
ALTER TABLE BlendSample ADD AmountUnit nvarchar(255);
ALTER TABLE BlendSample ADD CutIndex int;
ALTER TABLE BlendSample ADD SampleIndex int;
ALTER TABLE BlendSample ADD ContainerCount int;
ALTER TABLE BlendSample ADD Comments nvarchar(255);
ALTER TABLE BlendSample ADD BulkPlantId int;
ALTER TABLE BlendSample ADD StorageId int;
ALTER TABLE BlendSample ADD StorageName nvarchar(255);
ALTER TABLE BlendSample ADD SampleType nvarchar(255);

ALTER TABLE BlendSample DROP COLUMN [DateTime];
ALTER TABLE BlendSample DROP COLUMN [Label];
GO
