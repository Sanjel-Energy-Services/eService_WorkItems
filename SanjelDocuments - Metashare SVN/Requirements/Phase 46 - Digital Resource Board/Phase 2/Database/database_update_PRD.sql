...
update SanjelDataQA.dbo.RigJob set CallCrewTime = (select CIF_CALL_CREW_DATE_TIME from eservice6.dbo.CALLSHEET_HEADERS cs where cs.CALL_SHEET_NUMBER = RigJob.CallSheetNumber)
...
from eservice6.dbo.CALLSHEET_HEADERS CSH 
GO
...
from eservice6.dbo.PUMP_BLEND_SCTNS PBD 
...
from eservice6.dbo.PUMP_BLEND_BLEND_ADDTV_SCTNS PBD 
...
select 
	...
	cast(PBD.YIELD as float) as Yield,
	cast(PBD.SACK_WEIGHT as float) as SackWeight
from eservice6.dbo.PRG_BLEND_SCTNS PBD 
Join BlendAdditiveMeasureUnit BAMU on PBD.BLEND_AMOUNT_UNIT_ABBR = BAMU.Abbreviation and BAMU.effective_end_datetime > GETDATE()
GO
...
from eservice6.dbo.PRG_BLEND_BLEND_ADDTV_SCTNS PBD 
Join BlendAdditiveMeasureUnit BAMU on PBD.AMOUNT_UNIT_ABBR = BAMU.Abbreviation and BAMU.effective_end_datetime > GETDATE()
GO
*/
